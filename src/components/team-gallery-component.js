class TeamGallery extends HTMLElement {
  constructor () {
    super()
  ...
  render () {
    ...
    <style>
      ...
      .social-networks-menu-icon span {
      ...
      .social-networks-menu-icon.active{
        position: relative;
      }
      
      .social-networks-menu-icon.active span:first-of-type {
        transform: translateY(5px) rotate(45deg);
      }
      
      .social-networks-menu-icon.active span:nth-of-type(2) {
        opacity: 0;
      }   
      
      .social-networks-menu-icon.active span:last-of-type {
        transform: translateY(-5px) rotate(-45deg);
      }
    ...
    <div class="team-items">
      <div class="team-item">
        <div class="team-item-social-networks">
          <div class="social-networks-menu-icon">
            <span></span>
            <span></span>
            <span></span>
          </div>
    ...
    const hamburgerButtons = this.shadow.querySelectorAll('.social-networks-menu-icon')
...
customElements.define('team-gallery-component', TeamGallery)
